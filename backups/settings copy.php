...
<body>
  ...
  <main class="main-content">
    ...
    <div class="card">
        ...
        function displayLogFile($filePath, $title, $maxLines = 50) {
        ...
        displayLogFile('price_cron_daily.log', 'Daily Price Logs');
        displayLogFile('yields_cron_daily.log', 'Daily Yield Log');
        displayLogFile('cron/daily_update_historical_values.log', 'Daily Portfolio Value Log');
        ?>
    </div>
  </main>
